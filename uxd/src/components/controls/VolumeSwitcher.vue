<template>
  <div class="volume-changer">
    <button class="img-button" @click="muted == 'true' ? muted = 'false' : muted = 'true'">
      <svg v-if="muted == 'false'" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
      ...
      <svg v-if="muted == 'true'" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
